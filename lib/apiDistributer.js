...
export const addShelfGoodsOne = (data) => {
  return new Promise((resolve, reject) => {
    wx.request({
      url: apiUrl.apiUrl + 'nxdistributergoodsshelfgoods/addShelfGoodsOne',
      method: 'POST',
      data,
      header: {
        "content-type": 'application/json'
...
var NXDG_DECIMAL_FIELDS = [
  ...
  'nxDgBuyingPrice', 'nxDgPriceProfitOne', 'nxDgPriceProfitTwo', 'nxDgPriceProfitThree',
  'nxDgBuyingPriceOne', 'nxDgBuyingPriceTwo', 'nxDgBuyingPriceThree',
  'nxDgWillPrice', 'nxDgWillPriceOne', 'nxDgWillPriceTwo', 'nxDgWillPriceThree',
  'nxDgWillPriceOneWeight', 'nxDgWillPriceTwoWeight', 'nxDgWillPriceThreeWeight',
  'nxDgWillPriceOneAboutPrice', 'nxDgWillPriceTwoAboutPrice', 'nxDgWillPriceThreeAboutPrice',
  'nxDgOutTotalWeight', 'nxDgQuantityDays', 'nxDgItemsPerCarton',
  'nxDgGrossWeightJin', 'nxDgNetWeightJin', 'nxDgGrossWeightPricePerJin', 'nxDgNetWeightPricePerJin',
  'nxDgOuterGrossWeightJin', 'nxDgOuterNetWeightJin', 'nxDgOuterGrossWeightPricePerJin', 'nxDgOuterNetWeightPricePerJin',
  'nxDgGoodsHighestPrice', 'nxDgGoodsLowestPrice',
  'nxDgPriceFirstDay', 'nxDgPriceSecondDay', 'nxDgPriceThirdDay'
];
 ...
 */
export const disGetAllCustomer = (disId, labelId) => {
  return new Promise((resolve, reject) => {
...
export const disSaveOrUpdateGoodsTierPrice = (data) => {
  return new Promise((resolve, reject) => {
    wx.request({
      url: apiUrl.apiUrl + 'nxdistributergoodstierprice/saveOrUpdate',
      method: 'POST',
      data,
      success: (res) => { resolve({ result: res.data }) },
      fail: (e) => { reject(e); load.hideLoading(); wx.showToast({ title: '请检查网络', icon: 'none' }) }
