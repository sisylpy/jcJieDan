 ...
 * @param {*} data 
 */
const saveBossPurchaseBatchCommand = (endpoint, data) => {
  return new Promise((resolve, reject) => {
    getApp().ownerRequest({
...
export const saveBossPurchaseBatch = (data) =>
  saveBossPurchaseBatchCommand('saveBossPurchaseBatch', data)

export const saveBossDepartmentPurchaseBatch = (data) =>
  saveBossPurchaseBatchCommand('saveBossDepartmentPurchaseBatch', data)
