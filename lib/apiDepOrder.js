...
export const getNxSelfPurchaseAnalysis = (data) => {
  return requestNxPurchaseAnalysis('nxdistributerpurchasegoods/getNxSelfPurchaseAnalysis', data)
}

export const getNxPurchaseCountAnalysis = (data) => {
  return requestNxPurchaseAnalysis('nxdistributerpurchasegoods/getNxPurchaseCountAnalysis', data)
}

export const getNxUnitPriceAnalysis = (data) => {
  return requestNxPurchaseAnalysis('nxdistributerpurchasegoods/getNxUnitPriceAnalysis', data)
}

export const getNxPurchaseCategoryDetail = (data) => {
  return requestNxPurchaseAnalysis('nxdistributerpurchasegoods/getNxPurchaseCategoryDetail', data)
}

export const getNxSupplierAnalysis = (data) => {
  return requestNxPurchaseAnalysis('nxdistributerpurchasegoods/getNxSupplierAnalysis', data)
}

export const getNxInventoryBusinessAnalysis = (data) => {
  return requestNxPurchaseAnalysis('nxdistributergoodsshelfstockreduce/getNxInventoryBusinessAnalysis', data)
}
...
/** 配送商确认精彩账本退货批次已经处理完成。 */
export const completeJczbReturn = (data) => {
  return new Promise((resolve, reject) => {
    getApp().ownerRequest({
      url: apiUrl.apiUrl + 'nxdepartmentorders/completeJczbReturn',
      method: 'POST',
      data,
      header: {
        'content-type': 'application/x-www-form-urlencoded'
