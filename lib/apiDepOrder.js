...
export const getTaskStatus = (data) => {
  return new Promise((resolve, reject) => {
    wx.request({
      url: apiUrl.apiUrl + 'ocr/getTaskStatus/' + data,
      method: 'GET',
      success: function (res) {
        resolve({ result: res.data })
      },
...
export const depGetTaskList = (data) => {
  return new Promise((resolve, reject) => {
    wx.request({
      url: apiUrl.apiUrl + 'ocr/depGetTaskList' ,
      method: 'POST',
      data: {
        depId: data.depId,
        type: data.type,
 ...
 */
export const disGetTodayOrderCustomerRoute = (data) => {
  return new Promise((resolve, reject) => {
    wx.request({
      url: apiUrl.apiUrl + 'nxdepartmentorderspart/disGetTodayOrderCustomerRoute',
      method: 'POST',
      data: {
        disId: data.disId,
...
export const disGetCustomerDistanceMatrix = (data) => {
  return new Promise((resolve, reject) => {
    wx.request({
      url: apiUrl.apiUrl + 'nxdepartmentorderspart/disGetCustomerDistanceMatrix',
      method: 'POST',
      data:{
        disId: data.disId,
        fromLat: data.fromLat,
...
export const disGetDriversOptimalRoute = (data) => {
  return new Promise((resolve, reject) => {
    wx.request({
      url: apiUrl.apiUrl + 'nxdepartmentorderspart/disGetDriversOptimalRoute',
      method: 'POST',
      data: data,
      header: {
...
/**
 * OCR识别订单（图片）
 * @param {Object} data 包含 ImageBase64, SecretId, SecretKey, depId, disId 等
 */
 ...
 */
export const deleteBatchOrders = (data) => {
  return new Promise((resolve, reject) => {
    wx.request({
      url: apiUrl.apiUrl + 'nxdepartmentorders/deleteBatch',
      method: 'POST',
      timeout: 60000, // 60秒超时
      header: {
        'Content-Type': 'application/json'
 ...
 */
export const correctOrders = (data) => {
  return new Promise((resolve, reject) => {
    wx.request({
      url: apiUrl.apiUrl + 'ocr/correction',
      method: 'POST',
      timeout: 60000, // 60秒超时
      header: {
        'Content-Type': 'application/json'
 ...
 */
export const getPromptByKey = (promptKey) => {
  return new Promise((resolve, reject) => {
    wx.request({
      url: apiUrl.apiUrl + 'prompt/getByKey?promptKey=' + encodeURIComponent(promptKey),
      method: 'GET',
      success: (res) => {
        resolve({ result: res.data })
      },
