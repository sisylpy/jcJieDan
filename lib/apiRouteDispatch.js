      ...
      getApp().ownerRequest({
        ...
        success: function (res) {
          ...
          if (res.statusCode >= 400) {
            var requestError = new Error(body.msg || body.message || ('请求失败（' + res.statusCode + '）'))
            requestError.statusCode = res.statusCode
            requestError.errorCode = body.errorCode || ''
            requestError.provider = body.provider || ''
...
var DESKTOP_BASE = apiUrl.apiUrl + 'desktop-dispatch/v1/'
...
export const getDispatchPerformanceRoutes = function (data) {
  var query = {}
  if (data && data.startDate) query.startDate = data.startDate
  if (data && data.endDate) query.endDate = data.endDate
  if (data && data.driverUserId) query.driverUserId = data.driverUserId
  return wrapRequest({
    url: DESKTOP_BASE + 'performance/routes',
    method: 'GET',
    dispatchAuth: true,
    data: query
  })
...
export const getDispatchPerformanceRouteDetail = function (driverRouteId) {
  return wrapRequest({
    url: DESKTOP_BASE + 'performance/routes/' + driverRouteId,
    method: 'GET',
    dispatchAuth: true
  })
}
...
export const lockDispatchStopDriver = function (data) {
  return wrapRequest({
    url: BASE + 'dispatch/planning/stops/lock',
    method: 'POST',
    dispatchAuth: true,
    data: data
  })
...
export const unlockDispatchStopDriver = function (data) {
  return wrapRequest({
    url: BASE + 'dispatch/planning/stops/unlock',
    method: 'POST',
    dispatchAuth: true,
    data: data
  })
...
export const bindCustomerLongTermDriver = function (data) {
  return wrapRequest({
    url: BASE + 'dispatch/planning/customer-driver-bindings/bind',
    method: 'POST',
    dispatchAuth: true,
    data: data
  })
...
export const unbindCustomerLongTermDriver = function (data) {
  return wrapRequest({
    url: BASE + 'dispatch/planning/customer-driver-bindings/unbind',
    method: 'POST',
    dispatchAuth: true,
    data: data
  })
...
export const updateDriverEmploymentType = function (data) {
  return wrapRequest({
    url: BASE + 'drivers/' + data.driverUserId + '/employment-type',
    method: 'POST',
    dispatchAuth: true,
    data: {
      disId: data.disId,
...
function buildRouteExpansionRequest(payload) {
  payload = payload || {}
  var body = {}
  ;[
    'disId',
...
export const postDriverRouteExpansionPreview = function (payload) {
  payload = payload || {}
  return wrapRequest({
    url: resolveNxDisRouteDispatchPath('/api/nxdisroutedispatch/sandbox/driver-route-edit/expansion/preview'),
    method: 'POST',
    dispatchAuth: true,
    data: buildRouteExpansionRequest(payload)
  })
}
