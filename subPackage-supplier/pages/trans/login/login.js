...
Page({
  ...
  _canLogin() {
    ...
    if (this.data.disName !==  null && this.data.userName !==  null  && this.data.address !== null  && this.data.phone !== null ) {
      this.setData({
        canLogin: true,
      })
    }else{
  ...
  onChooseAvatar(e) {
    ...
    jjshUserSaveWithFile(filePathList,code, 1,disName,userName, address,phone).then((res) => {
      load.hideLoading();
