...
Page({
  ...
  onShareAppMessage: function (options) {
    return {
      title: this.data.depInfo.nxDepartmentName + '订货单', // 默认是小程序的名称(可以写slogan等)
      path: '/subPackage/pages/customer/chefOrder/chefOrder?depFatherId=' + this.data.depFatherId + '&disId=' 
       + this.data.disId,
