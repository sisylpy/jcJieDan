...
Page({
  ...
  shareImg() {
    ...
    var bigHeight = (that.data.windowHeight - 360 - that.data.navBarHeight) / globalData.rpxR;
  ...
  _createDisName(that,context, bigWidth, bigHeight ){
    ...
    var content = nickName + " 邀请您加入注册" + "时鲜管理系统"
    var left  = 50;
  ...
  query.select('#qrcode')
    ...
    .exec((res) => {
      ...
      QRCode({
        ...
        background: '#ffffff',
        foreground: '#000000',
        text:  "https://grainservice.club:8443/nongxinle/api/gbdistributer/nxGbDisRegist?disId=" + disId ,
      })
