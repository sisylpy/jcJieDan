...
createQrcode() {
  ...
  query.select('#qrcode')
    ...
    .exec((res) => {
      ...
      var disId = that.data.disInfo.nxDistributerId;
      var disName = that.data.disInfo.nxDistributerName;
      ...
      QRCode({
        ...
        background: '#ffffff',
        foreground: '#000000',
        text:  "https://grainservice.club:8443/nongxinle/api/nxdistributeruser/nxStaffRegister?disId=" + disId + '&disName=' + disName + '&admin=' + this.data.admin ,
      })
