...
Page({
  ...
  selectedFatherId(e){
   wx.navigateTo({
     url: '../fatherGoods/fatherGoods?fatherId=' + e.currentTarget.dataset.id+'&type=' + this.data.type+ '&id=' +  this.data.id + '&name=' + e.currentTarget.dataset.name,
   })
  },
  ...
  changeFatherId(e){
    wx.navigateTo({
      url: '../../goodsListExchange/goodsListExchange?fatherId=' + e.currentTarget.dataset.id+'&type=' + this.data.type+ '&id=' +  this.data.id + '&name=' + e.currentTarget.dataset.name,
    })
   },
