...
Page({
  ...
  toResGoods(){
    ...
    wx.navigateTo({
      ...
      '&gbDepFatherId=-1&resFatherId=-1&depSettleType=' + this.data.dep.nxDepartmentSettleType + '&beforeId=-1',
    })
  },
  ...
  toRecord(){
    ...
    wx.navigateTo({
      ...
      +'&depId=' + this.data.depId + '&depName=' + this.data.depName +
      '&gbDepFatherId=-1&resFatherId=-1&depType=' + this.data.dep.nxDepartmentType,
    })
