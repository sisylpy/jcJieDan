  ...
  methods: {
    ...
    changeWillPrice(e) {
      ...
      if (this.data.level == 1) {
        price = this.data.item.nxDgWillPriceOne;
        itemData = "item.nxDgWillPriceOne";
      }
      if (this.data.level == 2) {
        price = this.data.item.nxDgWillPriceTwo;
        itemData = "item.nxDgWillPriceTwo";
      }
      if (this.data.level == 3) {
        price = this.data.item.nxDgWillPriceThree;
        itemData = "item.nxDgWillPriceThree";
      }
    ...
    changePrice(e) {
      ...
      var itemDataDay = "item.nxDgBuyingPriceUpdate";
      if (type == 'add') {
        newPrice = (Number(price) + Number(0.1)).toFixed(1);
      }
      if (type == 'reduce') {
      ...
      this.setData({
        [itemData]: newPrice,
        [itemDataDay]: this._getUpdateDay(),
      })
      this._getPercent();
    },
